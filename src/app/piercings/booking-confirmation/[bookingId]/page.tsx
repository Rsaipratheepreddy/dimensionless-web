...
export default function BookingConfirmationPage() {
    ...
    const getStatusMessage = () => {
        ...
        return {
            ...
            message: 'Your piercing appointment has been successfully booked.',
            type: 'success'
        };
    };
                ...
                <div className="confirmation-card">
                    ...
                    <div className="booking-details">
                        <div className="detail-section">
                            <img
                                src={booking.piercing_designs.image_url || '/painting.png'}
                                alt={booking.piercing_designs.name}
                                className="design-image"
                            />
                            <h3>{booking.piercing_designs.name}</h3>
                        </div>
